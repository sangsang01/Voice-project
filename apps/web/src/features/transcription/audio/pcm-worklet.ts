export const PCM_WORKLET_PROCESSOR = "voice-pcm-frame";

export interface PcmWorkletMessage {
  type: "pcm-frame";
  sequence: number;
  startMs: number;
  samples: ArrayBuffer;
...
// This code runs in AudioWorkletGlobalScope, where it cannot import React or touch UI state.
export const pcmWorkletSource = String.raw`
