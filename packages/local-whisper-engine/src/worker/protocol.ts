...
export type MainToWorker =
  | { type: "prepare"; requestId: number; device: InferenceDevice }
...
export type WorkerEvent =
  ...
  | { type: "prepared"; requestId: number; device: InferenceDevice }
  | { type: "prepare.error"; requestId: number; device: InferenceDevice; message: string }
